...
<body>
  ...
  <header class="index-header relative-navbar">
    <div class="navbar__wrapper">
      <a href="index.php#naslovna" class="navbar__logo"><img src="css/img/nutri.logika.png" alt="nutri.logika" class="navbar__logo__img" /></a>
      <nav class="navbar">
  ...
  <main>
    <div class="single-post__wrapper">
      <div class="single-post__img--wrapper">
        <img src="css/img/blog/<?php echo $selectOne['image'] ?>" alt="<?php echo $post['title']; ?>" class="single-post__img" />
